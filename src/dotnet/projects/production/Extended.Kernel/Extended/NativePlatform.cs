...
namespace Extended
{
    ...
    public enum NativePlatform : uint
    {
        ...
        /// <summary>
        ///     Any Apple platform on 64-bit computing architecture. Includes <see cref="macOS" /> and
        ///     <see cref="iOS" />, and <see cref="tvOS" />.
        /// </summary>
        Apple = macOS | iOS | tvOS,

        /// <summary>
        ///     Some member of the Unix family on 64-bit computing architecture.
        /// </summary>
        Unix = Apple | Linux,
